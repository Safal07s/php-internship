            ...
            <div class="row">
              <div class="col-lg-3 col-md-12 mb-4 mb-lg-0">
                ...
                <div class="bg-image hover-overlay hover-zoom ripple rounded" data-mdb-ripple-color="light">
                  <img src="admin/uploads/<?php echo $sale_data['img_link']; ?>"
                    class="w-100" alt="" />
                  <a href="#!">
              ...
              <div class="col-lg-5 col-md-6 mb-4 mb-lg-0">
                <!-- Data -->
                <p><strong><?php echo $sale_data['title']; ?></strong></p>
                <p>Color: <?php echo $sale_data['color']; ?></p>
                <p>Size: <?php echo $sale_data['size']; ?></p>
              ...
              <div class="col-lg-4 col-md-6 mb-4 mb-lg-0">
                ...
                <p class="text-start text-md-center">
                  <strong>Rs:<?php echo $sale_data['sale_price']; ?></strong>
                </p>
                <!-- Price -->
              </div>
            </div>
