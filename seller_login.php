    ...
    <div class="forms">
        <div class="form-content">
          ...
          if (isset($_GET['error'])) {
                    ...
                    header("Refresh:2; URL=seller_login.php");
                }
          ...
          <form action="admin/auth/login-process.php" method="POST" enctype="multipart/form-data">
            <div class="input-boxes">
              <div class="input-box">
                ...
                <input type="text" name="username" class="form-control" placeholder="Enter your usernamex" required>
              </div>
              <div class="input-box">
              ...
              <div class="button input-box">
                <input type="submit" value="Sumbit" name="seller">
              </div>
