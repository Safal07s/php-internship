  ...
  <div class="pagetitle">
    ...
    <nav>
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">Create Site Map</li>
      </ol>
    </nav>
  </div><!-- End Page Title -->
  <section class="section">
    <div class="row">
      <div class="col-lg-12">
        ...
        <div class="card">
          <div class="card-body">
            <h5 class="card-title">Create Site Map</h5>
            ...
            if (isset($_POST['submit'])) {
              ...
              if ( $title != ""  && $description != "") {
                $insert = "INSERT INTO site_map( title, description)
VALUES('$title',  '$description')";
            ...
            ?>
                  <div class="alert alert-success alert-dismissible fade show" role="alert">
                    <strong>Site Map is created</strong>
                ...
                ?>
                  <div class="alert alert-danger alert-dismissible fade show" role="alert">
                    <strong>Site Map is not created</strong>
                    <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
                  </div>
            <?php
