...
<main id="main" class="main">
  ...
  <div class="pagetitle">
    <h1>Update Site Map</h1>
    <nav>
      <ol class="breadcrumb">
        <li class="breadcrumb-item"><a href="index.php">Home</a></li>
        <li class="breadcrumb-item">Site Map</li>
        <li class="breadcrumb-item active">Update Site Map</li>
      </ol>
    </nav>
  </div><!-- End Page Title -->
  <section class="section">
    <div class="row">
      <div class="col-lg-12">
        ...
        <div class="card">
          <div class="card-body">
            <h5 class="card-title">Update Site Map</h5>

            <?php
            if (isset($_GET['id'])) {
              $id = $_GET['id'];
              $show_query = "SELECT *FROM site_map WHERE id='$id'";
            ...
            if (isset($_POST['submit'])) {
              ...
              if ( $title != "" && $description != "") {
                $query = " UPDATE site_map SET  title='$title', description='$description'  WHERE id='$id'"; // variable
            ...
            ?>
                  <div class="alert alert-success alert-dismissible fade show" role="alert">
                    <strong>Site Map is Updated</strong>
                ...
                ?>
                  <div class="alert alert-danger alert-dismissible fade show" role="alert">
                    <strong>Site Map is not Updated</strong>
                    <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
                  </div>
            <?php
