...
<main id="main" class="main">
  ...
  <div class="pagetitle">
    <h1>Update Explore</h1>
    <nav>
      <ol class="breadcrumb">
        <li class="breadcrumb-item"><a href="index.php">Home</a></li>
        <li class="breadcrumb-item">Explore</li>
        <li class="breadcrumb-item active">Update Explore</li>
      </ol>
    </nav>
  </div><!-- End Page Title -->
  <section class="section">
    <div class="row">
      <div class="col-lg-12">
        ...
        <div class="card">
          <div class="card-body">
            <h5 class="card-title">Update Explore</h5>

            <?php
            if (isset($_GET['id'])) {
                $id = $_GET['id'];
                $show_query = "SELECT *FROM explore WHERE id='$id'";
            ...
            if( $name!= "" ){
                $query =" UPDATE explore SET  name='$name'   WHERE id='$id'"; // variable
            ...
            if ($result) {
                ?>
                            <div class="alert alert-success alert-dismissible fade show" role="alert">
                                <strong>Explore is Updated</strong>
                        ...
                        ?>
                            <div class="alert alert-danger alert-dismissible fade show" role="alert">
                                <strong>Explore is not Updated</strong>
                                <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
                            </div>
                <?php
