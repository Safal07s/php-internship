  ...
  <section class="section">
    <div class="row">
      <div class="col-lg-12">
        ...
        <div class="card">
          <div class="card-body">
            <h5 class="card-title">Create Privacy Policy</h5>
            ...
            if (isset($_POST['submit'])) {
              ...
              if ( $top_title != ""  && $title != ""  && $description != "") {
                $insert = "INSERT INTO privacy_policy( top_title,title, description)
VALUES('$top_title','$title',  '$description')";
                $result = mysqli_query($con, $insert);

                if ($result) {
            ?>
                  <div class="alert alert-success alert-dismissible fade show" role="alert">
                    <strong>Privacy Policy is created</strong>
                ...
                ?>
                  <div class="alert alert-danger alert-dismissible fade show" role="alert">
                    <strong>Privacy Policy is not created</strong>
                    <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
                  </div>
            <?php
            ...
            <form class="row g-3" action="" method="POST" enctype="multipart/form-data">
              ...
              <div class="col-md-6">
                ...
                <input type="text" class="form-control" name="top_title" id="inputName5">
              </div>
              <div class="col-md-6">
