      ...
      <div class="col-lg-12">
        ...
        <div class="card">
          <div class="card-body">
            ...
            if (isset($_GET['id'])) {
              $id = $_GET['id'];
              $show_query = "SELECT *FROM privacy_policy WHERE id='$id'";
            ...
            if (isset($_POST['submit'])) {
              ...
              if ($top_title != "" && $title != "" && $description != "") {
                $query = " UPDATE privacy_policy SET  top_title='$top_title',title='$title', description='$description'  WHERE id='$id'"; // variable
            ...
            ?>
                  <div class="alert alert-success alert-dismissible fade show" role="alert">
                    <strong>Privacy Policy is Updated</strong>
                ...
                ?>
                  <div class="alert alert-danger alert-dismissible fade show" role="alert">
                    <strong>Privacy Policy is not Updated</strong>
                    <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
                  </div>
            <?php
            ...
            <form class="row g-3" action="" method="POST" enctype="multipart/form-data">
              ...
              <div class="col-md-6">
                <label for="inputName5" class="form-label">Top Title</label>
                <input type="text" class="form-control" name="top_title" value="<?php echo $data['top_title']; ?>" id="inputName5">
              </div>
              <div class="col-md-6">
