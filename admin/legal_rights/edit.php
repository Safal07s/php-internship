...
<main id="main" class="main">
  ...
  <div class="pagetitle">
    <h1>Update Legal Rights</h1>
    <nav>
      <ol class="breadcrumb">
        <li class="breadcrumb-item"><a href="index.html">Home</a></li>
        <li class="breadcrumb-item">Legal Rights</li>
        <li class="breadcrumb-item active">Update Legal Rights</li>
      </ol>
    </nav>
  </div><!-- End Page Title -->
  <section class="section">
    <div class="row">
      <div class="col-lg-12">
        ...
        <div class="card">
          <div class="card-body">
            <h5 class="card-title">Update Legal Rights</h5>
            ...
            if (isset($_GET['id'])) {
              ...
              $id = $_GET['id'];
              $query = "SELECT * FROM legal_rights WHERE id=$id";
            ...
            if (isset($_POST['submit'])) {
              ...
              if ($title != "" && $copyright_title!="" && $file_name == "" && $description != "") {
                $querry = "UPDATE  legal_rights  SET  title='$title', copyright_title= '$copyright_title', description='$description' WHERE id='$id'";
                ...
                if ($file_size < 2000000) {
                  ...
                  if ($ext == 'jpg' || $ext == 'png' || $ext == 'jpeg') {
                    ...
                    if (move_uploaded_file($_FILES['dataFile']['tmp_name'], $target_file)) {
                      ...
                      $querry = "UPDATE  legal_rights  SET  title='$title',copyright_title= '$copyright_title', img_link='$finalname', type='$ext',description='$description'  WHERE id='$id'";
                      $result = mysqli_query($con, $querry);
                      if ($result) {
                        ?>
                        <div class="alert alert-success" role="alert">
                          <h4 class="alert-heading">Legal Rights is updated.</h4>
                          </div>
                        <?php
            ...
            <form action="" method="POST" enctype="multipart/form-data">
              ...
              <div class="mb-3">
                ...
                <input type="text" class="form-control" name="copyright_title" value="<?php echo $data['copyright_title']; ?>" id="input1" aria-describedby="emailHelp">
              </div>
