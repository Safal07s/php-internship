...
<?php
  ...
  <div class="pagetitle">
    <h1>Manage Legal Rights</h1>
    <nav>
      <ol class="breadcrumb">
        <li class="breadcrumb-item"><a href="index.php">Home</a></li>
        <li class="breadcrumb-item">Legal Rights</li>
        <li class="breadcrumb-item active">Manage Legal Rights</li>
      </ol>
    </nav>
  </div><!-- End Page Title -->
  ...
  <section class="section">
    <div class="row">
      <div class="col-lg-12">
        ...
        <div class="card">
          <div class="card-body">
            <h5 class="card-title">Manage Legal Rights</h5>
            ...
            <a class="btn btn-primary btn-sm " href="create.php" role="button">Add Files </a>
              ...
              <tbody>
                ...
                $select = 'SELECT *FROM legal_rights';
                ...
                ?>
                  <tr>
                    ...
                    <td><?php echo $data['copyright_title']; ?></td>
