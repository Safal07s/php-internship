      ...
      <div class="col-lg-12">
        ...
        <div class="card">
          <div class="card-body">
            ...
            if (isset($_GET['id'])) {
              $id = $_GET['id'];
              $show_query = "SELECT *FROM customer WHERE id='$id'";
            ...
            if (isset($_POST['submit'])) {
              ...
              if ($name != "" && $email != "" && $username != "") {
                $query = " UPDATE customer SET name='$name', email='$email', username='$username' WHERE id='$id'"; // variable
            ...
            ?>
                  <div class="alert alert-success alert-dismissible fade show" role="alert">
                    <strong>Customer is Updated</strong>
                ...
                ?>
                  <div class="alert alert-danger alert-dismissible fade show" role="alert">
                    <strong>Customer is not Updated</strong>
                    <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
                  </div>
            <?php
            ...
            <!-- Multi Columns Form -->
            <a class="btn btn-success btn-sm " href="index.php" role="button">Manage Customer </a>
